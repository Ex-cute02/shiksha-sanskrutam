...
<body>
   <table width="100%"> 
     <tr><td width="10%">
      ...
      <td><span id="title">Monier-Williams Sanskrit-English Dictionary, 1899</span></td>
      </tr>
    </table>
...
$href_fm_cologne="//www.sanskrit-lexicon.uni-koeln.de/scans/csldev/csldoc/build/dictionaries/mw.html";
if ($dictinfowhich == "cologne") {
 ...
 if ( is_dir($testpath)) {
  ...
  $href_fm = "$testpath/build/dictionaries/mw.html";
 } else {
...
?>
  ...
  <li><a href="mwheader.xml">License of Digital Edition</a></li>
  <li><a href="https://www.worldcat.org/title/sanskrit-english-dictionary-etymologically-and-philologically-arranged-with-special-reference-to-cognate-indo-european-languages/oclc/471589783">WorldCat reference</a></li>
  <li>Bibliographic entry: MONIER-WILLIAMS, M. (1899). A Sanskrit-English dictionary: Etymologically and philologically arranged with special reference to Cognate indo-european languages. Oxford, The Clarendon Press.</li>
 </ol>
